...
func isOverlap(firstRange []int, secondRange []int) bool {
	return !(firstRange[0] < secondRange[0] && firstRange[1] < secondRange[0]) && !(firstRange[0] > secondRange[1] && firstRange[1] > secondRange[1])
}
